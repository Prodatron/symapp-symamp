...
;### Input      (hrdbas)=platform (1=CPC, 2=MSX, 3=PCW, 4=EP)
;### Output     HL=hardware (b[0]=PSG, b[1]=MP3MSX, b[2]=Playcity, b[3]=Darky, b[4]=OPL4, b[5]=OPL3)
hrddet  ld a,(hrdbas)
        ld hl,0
        cp 1
        ret c
...
hrdini5 ld a,5              ;*** 6CHN psg
        bit 2,l
        jr nz,hrdini3       ;playcity -> use it
        inc a
        bit 3,l
        jr nz,hrdini3       ;darky    -> use it
        scf
...
;### Input      A=hardware (1=CPC PSG, 2=MSX PSG, 3=PCW PSG, 4=EP Dave, 5=CPC PlayCity, 6=MSX Darky),
;###            B=module type (0=SKM, 1=ST2, 3=PT3)

psgsetrou
;skm prepare, skm one reg output, reg read, pt3 all reg output, hardware init
dw sendregCPC,cpcskm,cpcreg,cpcpt3,cpcini  ;cpc
dw sendregMSX,msxskm,msxreg,msxpt3,msxini  ;msx
dw sendreg0  ,pcwskm,pcwreg,pcwpt3,pcwini  ;pcw
dw sendreg0  ,eprskm,eprreg,eprpt3,eprini  ;ep
dw sendreg0  ,pcyskm,pcyreg,pcypt3,pcyini  ;playcity
dw sendregMSX,dkyskm,dkyreg,dkypt3,dkyini  ;darky
...
psgsetst3
dw cpcst2,msxst2,pcwst2,eprst2,pcyst2,dkyst2
...
;### CPCINI -> inits MSX-PSG sound output
;### Input      A=module type (0=SKM, 1=ST2, 2=MP3, 3=PT3)
